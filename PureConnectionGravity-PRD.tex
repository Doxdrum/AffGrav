...
\begin{widetext}
  \begin{dmath*}
    ...
    + \big( D_7 T a - 16\, L_4 A T b - 8\, D_4 T p^2 d_1 + (2\, B_3 \sigma + \frac{4}{3}\, B_4 \sigma ) A E d_2 + (\frac{1}{2}\, B_3 + \frac{1}{3}\, B_4 + 2\, B_5) T u + ( - 2\, B_3 - \frac{4}{3}\, B_4) E T v_L + (\frac{3}{2}\, B_3 + B_4 + 6\, B_5) T y_1 + 8\, D_5 T T y_2 + ( - \frac{1}{2}\, B_3 - \frac{1}{3}\, B_4 - 2\, B_5 ) T p^2 y_L\big) i {p}^{m} {da}_{m} 
    ...
    + \big((2\, B_3 - \frac{8}{3}\, B_4) T a + 16\, D_4 A T b + (8\, B_1 + \frac{4}{3}\, B_2 + 4\, E_1) T p^2  d_1 + (- \frac{4}{3}\, B_4 - 2\, B_3) A E d_2 + ( - \frac{1}{2}\, C_1 + \frac{5}{3}\, C_2 + 2\, C_3) T u + (2\, C_1 - \frac{8}{3}\, C_2) E T v_L + (\frac{1}{2}\, C_1 + \frac{7}{3}\, C_2 + 6\, C_3) T y_1 + (8\, B_2 - 8\, E_1) T T y_2 + ( - \frac{3}{2}\, C_1 + C_2 - 2\, C_3) T p^2 y_L\big) i {p}^{m} {dg}^{0}\,_{0 m} 
    ...
    + \big(( - 2\, B_3 - \frac{4}{3}\, B_4) E T a_L + (16\, B_1 - \frac{40}{3}\, B_2 - 24\, E_1) E T b + ( - C_1 + \frac{4}{3}\, C_2) p^2 c_L + (2\, C_1 - \frac{8}{3}\, C_2) E E d_2 + (4\, C_1 - \frac{16}{3}\, C_2) E t + ( - 2\, C_1 + \frac{8}{3}\, C_2) E p^2 t_L + (2\, C_1 - \frac{8}{3}\, C_2) E T w_L + (3\, C_1 - 4\, C_2) T x + ( - C_1 + \frac{4}{3}\, C_2) T p^2 x_L + ( - 10\, C_1 + \frac{40}{3}\, C_2) E T z_2 + (2\, C_1 - \frac{8}{3}\, C_2) E T p^2 z_L\big) i {p}_{m} {dg}^{m}\,_{0 0} 
  ...
  \begin{dmath}
    ...
    + \big((- 8\, B_1 + \frac{8}{3}\, B_2 + 8\, E_1) T d_1 + ( - C_1 + \frac{4}{3}\, C_2)  d_2 + (B_3 + \frac{2}{3}\, B_4) A t_L + (C_1 - \frac{4}{3}\, C_2) T y_L + ( 2\, B_3 + \frac{4}{3}\, B_4) A T z_L \big) i {p}^{n} {p}^{p} {p}_{m} {dg}^{m}\,_{n p} 
    + \big( ( - 2\, B_3 \sigma + \frac{8}{3}\, B_4 \sigma - D_7 ) A a + ( - 16\, D_4 \sigma + 16\, L_4) A A b + (4\, D_5 - 8\, E_1 \sigma) A p^2  d_1 + ( - \frac{1}{2}\, B_3 - \frac{1}{3}\, B_4 - 2\, B_5 + \frac{1}{2}\, C_1 \sigma - \frac{5}{3}\, C_2 \sigma - 2\, C_3 \sigma) A u + (C_1 - \frac{4}{3}\, C_2) p^2 v_L + (\frac{1}{2}\, B_3 + \frac{1}{3}\, B_4 - 6\, B_5 - \frac{5}{2}\, C_1 \sigma + \frac{1}{3}\, C_2 \sigma - 6\, C_3 \sigma) A y_1 + ( - 8\, B_2 \sigma - 8\, D_5 + 8\, E_1 \sigma) A T y_2 + (\frac{1}{2}\, B_3 + \frac{1}{3}\, B_4 + 2\, B_5 + \frac{3}{2}\, C_1 \sigma - C_2 \sigma + 2\, C_3 \sigma) A p^2 y_L\big) i {p}_{m} {dt}^{0 0 m} 
    + \big(( - 2\, D_4 + D_5) T a - 4\, L_4 A T a_L + (4\, D_4 \sigma - 4\, L_4) A A c_L + (12\, D_2 - 4\, D_1) T p^2 d_1 + (( - 4\, D_5 + 4\, E_1 \sigma) A E  + ( - 8\, L_1 + 8\, L_2) T T ) d_2 + 2\, D_5 A t - 2\, D_5 A p^2 t_L + (2\, B_1 + \frac{4}{3}\, B_2) T u + (4\, B_1 + \frac{2}{3}\, B_2 - 6\, E_1) E T v_L + 4\, D_4 A T w_L + (2\, B_1 - \frac{2}{3}\, B_2 - 2\, E_1) T y_1 + (( - B_3 - \frac{2}{3}\, B_4 - C_1 \sigma + \frac{4}{3}\, C_2 \sigma) A E + 8\, D_2 T T) y_2 + (2\, B_1 - \frac{2}{3}\, B_2 - 2\, E_1) T p^2  y_L + 6\, D_5 A T z_1 + 4\, D_5 A T z_2 - 2\, D_5 A T p^2 z_L\big) i {\epsilon}_{m n p} {p}^{m} {dt}^{0 n p} 
  \end{dmath}
\end{widetext}
