...
As a matter of fact, the vector field and the ``gravitational" sector of the torsion disengage when $A_2$
...
The  analysis of the degrees of freedom of the 2+1 action is pretty straightforward because it clearly corresponds to a gravitational action plus some extra stuff. In 3+1 dimensions there is not a clear  equivalence between the model described by Eq.~\eqref{4dfull} to anything known, an deeper  analysis should be done. Hence, one proposes a decomposition of the fields
\begin{align}
