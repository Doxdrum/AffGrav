...
\begin{align}
  ...
  \end{split}
\end{align}
where the coefficients $B_i$ are related with the original coefficients $C_i$ and $D_i$. Moreover, the general curvature can be decomposed into the Riemann curvature plus extra contributions, through the use of the connection decomposition %\footnote{The symbol $\hat{\Gamma}^\lambda{}_{\mu\rho}$ represents the Levi-\v{C}vita connection.}
\begin{align}
